...
if __name__=='__main__':
    ...
    list_of_plots = {
        ...
        'C_P_with_10_mps': {'fit': False, 'y_label': r'$C_P$', 'y_data': 'propulsive_power_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        'C_P_with_10_mps_with_fit': {'fit': 'C_P', 'y_label': r'$C_P$', 'y_data': 'propulsive_power_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_P_electric_with_10_mps': {'fit': False, 'y_label': r'$C_P$ (electric)', 'y_data': 'prop_electric_power', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_P_shaft_with_10_mps': {'fit': False, 'y_label': r'$C_P$ (shaft)', 'y_data': 'prop_shaft_power', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_L_with_10_mps': {'fit': False, 'y_label': r'$C_L$', 'y_data': 'CL_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_mc4_with_10_mps': {'fit': False, 'y_label': r'$C_{m,c/4}$', 'y_data': 'C_m_c4_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_T_with_10_mps': {'fit': False, 'y_label': r'$C_T$', 'y_data': 'C_T_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'C_T_with_10_mps_with_fit': {'fit': 'C_T', 'y_label': r'$C_T$', 'y_data': 'C_T_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'eta_propulsive_with_10_mps': {'fit': False, 'y_label': r'$\eta_{propulsive}=\frac{1}{\eta_{recuperation}}$', 'y_data': 'propulsive_efficiency_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'eta_recuperation_with_10_mps': {'fit': False, 'y_label': r'$\eta_{recuperation}=\frac{1}{\eta_{propulsive}}$', 'y_data': 'efficiency_recuperation', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'DC_m_c4_with_10_mps': {'fit': False, 'y_label': r'$\Delta C_{m,c/4}=C_{m,c/4} - C_{m,c/4,propoff}$', 'y_data': 'DCm_c4_cor', 'with_10_mps': True, 'x_data': 'J_cor', 'x_label': 'J', 'c_data': 'AoA_cor', 'c_label': 'Angle of Attack (degrees)'},
        ...
        'CLCD_vs_CL_with_10_mps': {'fit': {'ydat':'CL_propoff/CBX_propoff', 'xdat': 'CL_propoff'}, 'y_label': r'$C_L/C_D$', 'y_data': 'CL_cor/CD_cor', 'with_10_mps': True, 'x_data': 'CL_cor', 'x_label': r'$C_L$', 'c_data': 'J_cor', 'c_label': 'J (corrected)'},
        ...
        'CL_vs_CD_with_10_mps': {'fit': {'ydat':'CL_propoff', 'xdat': 'CBX_propoff'}, 'y_label': r'$C_L$', 'y_data': 'CL_cor', 'with_10_mps': True, 'x_data': 'CD_cor', 'x_label': r'$C_D$', 'c_data': 'J_cor', 'c_label': 'J (corrected)'},
        ...
        'Cmc4_vs_AoA_with_10_mps': {'fit': {'ydat':'CM_c4_propoff', 'xdat': 'AoA_propoff'}, 'y_label': r'$C_{m,c/4}$', 'y_data': 'C_m_c4_cor', 'with_10_mps': True, 'x_data': 'AoA_cor', 'x_label': r'Angle of Attack (degrees)', 'c_data': 'J_cor', 'c_label': 'J (corrected)'},
        ...
        'DCmc4_vs_AoA_with_10_mps': {'fit': False, 'y_label': r'$\Delta C_{m,c/4} = C_{m,c/4} - C_{m,c/4,propoff}$ ', 'y_data': 'DCm_c4_cor', 'with_10_mps': True, 'x_data': 'AoA_cor', 'x_label': r'Angle of Attack (degrees)', 'c_data': 'J_cor', 'c_label': 'J (corrected)'},
        ...
        'CL_vs_AoA_with_10_mps': {'fit': {'ydat':'CL_propoff', 'xdat': 'AoA_propoff'}, 'y_label': r'$C_L$', 'y_data': 'CL_cor', 'with_10_mps': True, 'x_data': 'AoA_cor', 'x_label': r'Angle of Attack (degrees)', 'c_data': 'J_cor', 'c_label': 'J (corrected)'},
    }
